...
local XarusSSv11 = Instance.new("ScreenGui")
...
local ersion = Instance.new("TextLabel")
...
local _smoothinputframe = Instance.new("ScrollingFrame")
...
Topbar.Position = UDim2.new(0.291970789, 0, 0.256238133, 0)
Topbar.Size = UDim2.new(0.415510952, 0, 0.48453173, 0)
Topbar.Visible = true
Topbar.Active = true
...
ersion.Name = "ersion"
ersion.Parent = Topbar
ersion.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ersion.BackgroundTransparency = 1.000
ersion.Position = UDim2.new(0.100000001, 0, 0.0649999976, 0)
ersion.Size = UDim2.new(0.266666591, 0, 0.0627413914, 0)
ersion.Font = Enum.Font.Gotham
ersion.Text = "v.1.1 (pre-beta)"
ersion.TextColor3 = Color3.fromRGB(0, 0, 0)
ersion.TextScaled = true
ersion.TextSize = 14.000
ersion.TextWrapped = true
...
Circle.Name = "Circle"
Circle.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar.Execute.RippleEffect
...
Circle_2.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar["Hide-Code"].RippleEffect
...
Circle_3.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar["R6"].RippleEffect
...
Circle_4.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar.Respawn.RippleEffect
...
Circle_5.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar.Rejoin.RippleEffect
...
_smoothinputframe.Name = "_smoothinputframe"
_smoothinputframe.Parent = Topbar
_smoothinputframe.Active = true
_smoothinputframe.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
_smoothinputframe.BackgroundTransparency = 1.000
_smoothinputframe.BorderSizePixel = 0
_smoothinputframe.Position = UDim2.new(0, 0, 0.134615302, 0)
_smoothinputframe.Size = UDim2.new(0, 530, 0, 227)
_smoothinputframe.ZIndex = 2
_smoothinputframe.BottomImage = "rbxassetid://148970562"
_smoothinputframe.CanvasSize = UDim2.new(0, 0, 15, 400)
_smoothinputframe.MidImage = "rbxassetid://148970562"
_smoothinputframe.ScrollBarThickness = 5
_smoothinputframe.TopImage = "rbxassetid://148970562"

Hidden.Name = "Hidden"
Hidden.Parent = Topbar
...
Circle_6.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar.Clear.RippleEffect
...
Circle_7.Parent = game.StarterGui.Model["Xarus SS v.1.1"].Topbar.ButtonScripts.CircleClick
...
Circle_7.ImageTransparency = 0.800

RejoinCheck.Name = "RejoinCheck"
RejoinCheck.Parent = XarusSSv11
...
Circle_8.Parent = game.StarterGui.Model["Xarus SS v.1.1"].RejoinCheck.Yes.RippleEffect
...
Circle_9.Parent = game.StarterGui.Model["Xarus SS v.1.1"].RejoinCheck.No.RippleEffect
...
local function GFNK_fake_script() -- Topbar.SmoothScroll 
...
coroutine.wrap(GFNK_fake_script)()
local function JGQNCJ_fake_script() -- ImageButton.LocalScript 
...
coroutine.wrap(JGQNCJ_fake_script)()
local function VDSSVX_fake_script() -- Topbar.Dragify 
	local script = Instance.new('LocalScript', Topbar)
...
coroutine.wrap(VDSSVX_fake_script)()
local function LCLDXHP_fake_script() -- FPS.LocalScript 
...
coroutine.wrap(LCLDXHP_fake_script)()
local function EZKAQL_fake_script() -- Execute.LocalScript 
...
coroutine.wrap(EZKAQL_fake_script)()
local function YSQWC_fake_script() -- Execute.LocalScript 
	local script = Instance.new('LocalScript', Execute)
...
coroutine.wrap(YSQWC_fake_script)()
local function DUMDAKR_fake_script() -- nil.RippleClick 
...
coroutine.wrap(DUMDAKR_fake_script)()
local function SJRVHKP_fake_script() -- Execute.LocalScript 
	local script = Instance.new('LocalScript', Execute)
...
coroutine.wrap(SJRVHKP_fake_script)()
local function BDXOJF_fake_script() -- Execute.Script 
...
coroutine.wrap(BDXOJF_fake_script)()
local function HTYTVG_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(HTYTVG_fake_script)()
local function EMRVVDD_fake_script() -- HideCode.LocalScript 
...
coroutine.wrap(EMRVVDD_fake_script)()
local function QWBI_fake_script() -- HideCode.LocalScript 
	local script = Instance.new('LocalScript', HideCode)
...
coroutine.wrap(QWBI_fake_script)()
local function AFGZM_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(AFGZM_fake_script)()
local function ROZT_fake_script() -- R6.LocalScript 
...
coroutine.wrap(ROZT_fake_script)()
local function ATKZTR_fake_script() -- R6.Script 
...
coroutine.wrap(ATKZTR_fake_script)()
local function ERKCOA_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(ERKCOA_fake_script)()
local function QXGMLG_fake_script() -- Respawn.LocalScript 
...
coroutine.wrap(QXGMLG_fake_script)()
local function TBRC_fake_script() -- Respawn.LocalScript 
	local script = Instance.new('LocalScript', Respawn)
...
coroutine.wrap(TBRC_fake_script)()
local function DXALF_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(DXALF_fake_script)()
local function YWKB_fake_script() -- Rejoin.LocalScript 
...
coroutine.wrap(YWKB_fake_script)()
local function GBSJ_fake_script() -- Rejoin.LocalScript 
	local script = Instance.new('LocalScript', Rejoin)
...
coroutine.wrap(GBSJ_fake_script)()
local function VOCCWAF_fake_script() -- Clear.LocalScript 
...
coroutine.wrap(VOCCWAF_fake_script)()
local function RHVU_fake_script() -- Clear.LocalScript 
	local script = Instance.new('LocalScript', Clear)
...
coroutine.wrap(RHVU_fake_script)()
local function TPCRABB_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(TPCRABB_fake_script)()
local function IVIEZ_fake_script() -- Topbar.ButtonScripts 
	local script = Instance.new('LocalScript', Topbar)
...
coroutine.wrap(IVIEZ_fake_script)()
local function IRBJFH_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)

	moduleLocation = script.Parent
	
end
coroutine.wrap(IRBJFH_fake_script)()
local function YKDH_fake_script() -- RejoinCheck.Dragify 
...
coroutine.wrap(YKDH_fake_script)()
local function ITQC_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(ITQC_fake_script)()
local function KCDN_fake_script() -- Yes.LocalScript 
...
coroutine.wrap(KCDN_fake_script)()
local function INED_fake_script() -- Yes.LocalScript 
	local script = Instance.new('LocalScript', Yes)
...
coroutine.wrap(INED_fake_script)()
local function ZOZYW_fake_script() -- nil.RippleClick 
	local script = Instance.new('LocalScript', nil)
...
coroutine.wrap(ZOZYW_fake_script)()
local function NHYVRS_fake_script() -- No.LocalScript 
...
coroutine.wrap(NHYVRS_fake_script)()
local function QDMND_fake_script() -- No.LocalScript 
	local script = Instance.new('LocalScript', No)
...
coroutine.wrap(QDMND_fake_script)()
